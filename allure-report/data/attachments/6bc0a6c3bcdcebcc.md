...
- Name: auth/forgotLogInInfo/forgotInfoNegative.spec.js >> Successful `Sign in` flow test
- Location: tests/auth/forgotLogInInfo/forgotInfoNegative.spec.js:16:5
...
Call log:
  - waiting for locator('[id="customer.username"]')
