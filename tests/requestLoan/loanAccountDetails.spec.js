...
test('Successful `Loan Request` details', async ({ 
    ...
    await requestLoanPage.assertAccountDetailsIsVisible();
    await requestLoanPage.assertAccountBalance(MIN_LOAN_AMOUNT);
    await requestLoanPage.assertAccountType('LOAN');
});